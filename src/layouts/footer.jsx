              ...
              <div className="row" data-aos="fade-right">
                  ...
                  <div className="col-lg-3 py-4 py-md-5">
                      <div>
                          ...
                          <div className="d-flex align-items-center py-2">
                              <i className="fas fa-caret-right"></i>
                              <a href="#services"><p className="ms-3">Services</p></a>
                          </div>
                          <div className="d-flex align-items-center py-2">
                              <i className="fas fa-caret-right"></i>
                              <a href="#contact"><p className="ms-3">Contact</p></a>
                          </div>
                      </div>
                  </div> 
                  ...
                  <div className="col-lg-3 py-4 py-md-5">
                      <div>
                          ...
                          <div className="d-flex align-items-center py-2">
                              <i className="fas fa-caret-right"></i>
                              <a href="#"><p className="ms-3">Privacy</p></a>
                              
                          </div>
                          <div className="d-flex align-items-center py-2">
                              <i className="fas fa-caret-right"></i>
                              <a href="#"><p className="ms-3">Terms</p></a>
                          </div>
                          <div className="d-flex align-items-center py-2">
                              <i className="fas fa-caret-right"></i>
                  ...
                  <div className="col-lg-3 py-4 py-md-5">
                      ...
                      <p className="py-3 para-light">Just email to us</p>
                      <div className="d-flex align-items-center">
